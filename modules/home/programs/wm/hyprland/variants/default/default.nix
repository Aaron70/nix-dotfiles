...
with lib; with myLib;
let
  cfg = config.programs.home.hyprland;
  ...
  config = mkIf (config.profile.withGUI && cfg.enable && cfg.variant == "default") {
    services.hyprpaper = {
      ...
      settings = {
        ...
        preload = "${./wallpapers/tokyo.jpg}";
        wallpaper = ",${./wallpapers/tokyo.jpg}";
      };
    };
    ...
    wayland.windowManager.hyprland = {
      ...
      # ====================|Variables|====================
        "$mod" = "ALT";
        "$terminal" = profile.terminal.name;
      ...
      # ====================|Window Rules|====================
        windowrule = [
          "opacity 1.0 override 1.0 override,,title:(.*)(YouTube|Youtube|youtube)(.*)"
        ];
      # ====================|Window Rules|====================
